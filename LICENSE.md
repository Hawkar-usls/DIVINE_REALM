...
This repository is published as a public demonstration and partnership-evaluation artifact. It is **not open-source software** and no production or commercial license is granted by publication on GitHub.
...
- run an unmodified copy for internal, non-production evaluation;
- perform internal technical, security, compliance, regulatory, interoperability, scientific-partner, or partnership assessment;
- make only those temporary or internal copies reasonably necessary for the permitted evaluation.

This grant is non-exclusive, non-transferable, non-sublicensable, revocable for material breach, and limited to evaluation purposes.
...
Any commercial, production, distribution, white-label, operator, platform, aggregator, data-center, scientific-compute, hosted, or other deployment requires a separate written agreement with the copyright holder and, where applicable, appropriate rights from the workload/data owner.
...
## 7. No gambling, financial, scientific, medical, or deployment authorization

This license does not authorize real-money gambling, wagering, payments, mining, participation in a live scientific-compute network, medical activity, or operation in any regulated market.

Any such deployment requires independent legal, regulatory, security, privacy, platform-policy, scientific-partner, data-rights, ethics, and responsible-gaming review as applicable.
...
Third-party material, scientific datasets, provider code, and workload-owner materials retain their original rights; this repository-level licence does not override them.

## 9. Disclaimer

THE SOFTWARE AND DOCUMENTATION ARE PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, SECURITY, AVAILABILITY, COMMERCIAL SUCCESS, SCIENTIFIC VALIDITY, OR REGULATORY COMPLIANCE.

The public demo is not a warranty that production scientific workloads are connected, that scientific impact has been achieved, or that any particular compute economics will be realized.

## 10. Ecosystem and acquisition boundary

DIVINE_REALM is a specialized JANUS/HELIOS ecosystem child. Access to or acquisition of another repository does not automatically transfer DIVINE_REALM.

In particular:

- a JANUS HELIOS-only licence or acquisition does **not** include `Hawkar-usls/DIVINE_REALM` unless the definitive agreement expressly lists it;
- access to DIVINE_REALM does not transfer JANUS HELIOS, SSlot, other JANUS repositories, future inventions, general seller know-how, personal accounts, credentials, partner relationships, datasets, workload rights, or trademarks;
